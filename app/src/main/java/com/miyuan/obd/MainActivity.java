...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        findViewById(R.id.simulate_open).setOnClickListener(this);
        findViewById(R.id.simulate_close).setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.cleanFaultCode:
                ...
                break;
            case R.id.simulate_open:
                sample_text.setText(String.valueOf(OBDCore.getInstance(this).simulateAcc(true)));
                break;
            case R.id.simulate_close:
                sample_text.setText(String.valueOf(OBDCore.getInstance(this).simulateAcc(false)));
                break;
