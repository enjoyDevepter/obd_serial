...
int TS_RESP_verify_signature(PKCS7 *token, STACK_OF(X509)

*certs,
X509_STORE *store, X509
**signer_out);
...
int TS_ext_print_bio(BIO *bio, const STACK_OF(X509_EXTENSION)
